...
Sprite   GP_ONE_2::spriteMemory[MAX_SPRITE_COUNT];
uint16_t GP_ONE_2::frameBuffer[FRAMEBUFFER_BUF_SIZE];

void GP_ONE_2::loadSprites(const Sprite *sprites, uint16_t spriteCount) {
...
void GP_ONE_2::clearFrameBuffer(BackGroundColor bkgColor) {
...
void GP_ONE_2::drawSpriteInstances(uint16_t command_size, const SpriteInstance *instances, uint16_t instanceCount) {
    ...
    for (uint16_t currSprite = 0; currSprite < instanceCount; currSprite++){
        ...
        for (uint16_t i = 0; i < SPRITE_TILES_Y; ++i) {
            ...
            color_m64  = _mm_set_epi16( 0,0,0,0,spriteMemory[Sind].color[Sprite_Shift+3] >> shift_coor_X,spriteMemory[Sind].color[Sprite_Shift+2] >> shift_coor_X,spriteMemory[Sind].color[Sprite_Shift+1] >> shift_coor_X,spriteMemory[Sind].color[Sprite_Shift] >> shift_coor_X);
            alpha_m64  = _mm_set_epi16( 0,0,0,0,spriteMemory[Sind].alpha[Sprite_Shift+3] >> shift_coor_X,spriteMemory[Sind].alpha[Sprite_Shift+2] >> shift_coor_X,spriteMemory[Sind].alpha[Sprite_Shift+1] >> shift_coor_X,spriteMemory[Sind].alpha[Sprite_Shift] >> shift_coor_X);
            buffer_m64 = _mm_set_epi16( 0,0,0,0,frameBuffer[global_And_Sprite_Shift+3],frameBuffer[global_And_Sprite_Shift+2],frameBuffer[global_And_Sprite_Shift+1],frameBuffer[global_And_Sprite_Shift]);
            ...
            if (shift_coor_X != uint16_t(0)){
                ...
                color_m64  = _mm_set_epi16( 0,0,0,0,spriteMemory[Sind].color[Sprite_Shift+3] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].color[Sprite_Shift+2] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].color[Sprite_Shift+1] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].color[Sprite_Shift] << (uint16_t(16)-shift_coor_X));
                alpha_m64  = _mm_set_epi16( 0,0,0,0,spriteMemory[Sind].alpha[Sprite_Shift+3] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].alpha[Sprite_Shift+2] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].alpha[Sprite_Shift+1] << (uint16_t(16)-shift_coor_X),spriteMemory[Sind].alpha[Sprite_Shift] << (uint16_t(16)-shift_coor_X));
                buffer_m64 = _mm_set_epi16( 0,0,0,0,frameBuffer[global_And_Sprite_Shift+uint16_t(4)],frameBuffer[global_And_Sprite_Shift+uint16_t(3)],frameBuffer[global_And_Sprite_Shift+uint16_t(2)],frameBuffer[global_And_Sprite_Shift+uint16_t(1)]);
...
void GP_ONE_2::saveFrameBuffer(FrameBuffer &outFrameBuffer) {
    for (uint16_t i = 0; i < FRAMEBUFFER_BUF_SIZE; i++)
